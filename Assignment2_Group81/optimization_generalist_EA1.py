...
# ALGO FUNCTIONS WITH ADAPTIVE PARAMS
# selection: tournament with fixed size
# Recombination: uniform crossover with probablility 1/(a*log10(x+1))
# mutation: always mutate the child with gaussian mutation adaptive 
# adaptive crossover rate
# Survival selection : inverse tournament
...
mutation_par=2
tournament_size = 8
algorithm = 'EA1' # select algorithm: nn, choreo
